    ...
    <div class="px-4 py-2 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center lg:hidden">
                <button id="sidebar-toggle-mobile" type="button" class="text-gray-500 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-maroon-500">
            ...
            <div class="flex items-center ml-auto space-x-4">
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open" type="button" class="flex items-center space-x-3 text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-maroon-500">
                        <div class="h-8 w-8 rounded-full bg-maroon-600 flex items-center justify-center">
