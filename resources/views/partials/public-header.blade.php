        ...
        <div class="flex justify-between items-center h-16 lg:h-20">
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-8">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition class="absolute left-0 mt-2 w-64 bg-white rounded-md shadow-lg py-1 z-10 border border-gray-200" style="display: none;">
                        <a href="{{ route('dip.category', 'all') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Semua Informasi</a>
                        <hr class="my-1">
                        <a href="{{ route('dip.category', 'informasi-berkala') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Informasi Berkala</a>
                        <a href="{{ route('dip.category', 'informasi-serta-merta') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Informasi Serta-Merta</a>
                        <a href="{{ route('dip.category', 'informasi-setiap-saat') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Informasi Setiap Saat</a>
                        <a href="{{ route('dip.category', 'informasi-dikecualikan') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Informasi Dikecualikan</a>
                    </div>
                </div>
