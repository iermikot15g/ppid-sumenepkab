...
@section('title', 'Edit Tugas dan Fungsi')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form method="POST" action="{{ route('pembantu.cms.profil.update-tugas-fungsi') }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ Storage::url($opd->tusi_pdf) }}" target="_blank" class="text-blue-600 hover:underline">
