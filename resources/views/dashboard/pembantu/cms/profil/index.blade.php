    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="{{ route('pembantu.cms.profil.about') }}" 
           class="block bg-white rounded-lg shadow hover:shadow-md transition p-6 text-center">
            ...
            <p class="text-xs text-gray-500 mt-1">Visi Misi, Profil, Alamat, Kontak, Logo</p>
        </a>
        ...
        <a href="{{ route('pembantu.cms.profil.duties') }}" 
           class="block bg-white rounded-lg shadow hover:shadow-md transition p-6 text-center">
            ...
            <p class="text-xs text-gray-500 mt-1">Tugas pokok dan fungsi OPD</p>
        </a>
        ...
        <a href="{{ route('pembantu.cms.profil.structure') }}" 
           class="block bg-white rounded-lg shadow hover:shadow-md transition p-6 text-center">
            ...
            <p class="text-xs text-gray-500 mt-1">Upload gambar struktur organisasi</p>
        </a>
        ...
        <a href="{{ url('/dashboard/pembantu/legal-documents') }}" 
           class="block bg-white rounded-lg shadow hover:shadow-md transition p-6 text-center">
            ...
            <p class="text-xs text-gray-500 mt-1">Kelola dokumen peraturan OPD</p>
        </a>
    </div>

    <!-- Preview Informasi OPD (Opsional) -->
