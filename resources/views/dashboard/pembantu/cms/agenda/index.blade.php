...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('pembantu.cms.agenda.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
            + Tambah Agenda
        </a>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-right text-sm">
                            <a href="{{ route('pembantu.cms.agenda.edit', $item->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
