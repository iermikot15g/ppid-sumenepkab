...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form method="POST" action="{{ route('pembantu.cms.agenda.store') }}">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="content" rows="5" class="w-full border-gray-300 rounded-md shadow-sm font-mono text-sm">{{ old('content') }}</textarea>
                </div>

                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="is_published" value="1" class="rounded border-gray-300" {{ old('is_published') ? 'checked' : '' }}>
