...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form method="POST" action="{{ route('utama.cms.public-services.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-maroon-500 focus:border-maroon-500">{{ old('description') }}</textarea>
                ...
                <div>
                    ...
                    <input type="url" name="url" value="{{ old('url') }}" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-maroon-500 focus:border-maroon-500" required>
                    <p class="text-xs text-gray-500 mt-1">Contoh: https://layanan.diskominfo.sumenepkab.go.id</p>
                ...
                <div>
                    ...
                    <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" class="w-32 border-gray-300 rounded-md shadow-sm focus:ring-maroon-500 focus:border-maroon-500">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="rounded border-gray-300 text-maroon-600 focus:ring-maroon-500">
