...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('utama.cms.profil.index') }}" class="text-gray-600 hover:text-gray-800">← Kembali</a>
        </div>

        <form method="POST" action="{{ route('utama.cms.profil.update', $page->page_key) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <a href="{{ Storage::url($page->pdf_file_path) }}" target="_blank" class="text-blue-600 hover:underline">
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('utama.cms.profil.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">Batal</a>
...
<!-- Simple JavaScript untuk preview (opsional) -->
<script>
    // Tambahan: tombol preview sederhana
    document.addEventListener('DOMContentLoaded', function() {
        const textarea = document.getElementById('content');
        if (textarea) {
            // Tidak ada editor WYSIWYG, hanya textarea biasa
